...
@section('content')
    ...
    <div class="jumbotron py-4 px-5">
        ...
        <p><a href="{{ route('home.page') }}" style="text-decoration: none"> Home / </a><a href="{{ route('lates.rekap') }}" style="text-decoration: none">Data Rekapitulasi</a> / Detail Data Keterlambatan</p>
